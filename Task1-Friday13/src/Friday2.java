...
public class Friday2 {
    public static void main(String[] args) {
        ...
        //консольный ввод месяца
         ...
         int year = 1900; //Integer.parseInt(scaner.nextLine());
         int yearenter = 1900;
         ...
         if (year <= NowYear && year > 1899 && month >= 0 && month < 12) {
             ...
             System.out.println("С " + yearenter + " года количество пятниц 13 в месяце " + (month+1) + " равно " + kol);
         } else
             System.out.println("Введите правильные значения! Месяц в числовом формате от 0 до 11. Год в числовом формате от 1900 до 2016");
    }
